...
export class BlueTriangleGoal extends Structure {
	public readonly theCase: BlueTriangleGoalCase;
	public readonly randomSeed: number;

	constructor(theCase: BlueTriangleGoalCase, randomSeed: number) {
		super();
...
export class BlueTriangleGoalEmptyCase extends BlueTriangleGoalCase {
	public getElements(): ScoringObject[] {
		return [];
	}
...
export class BlueTriangleGoalWithColumnsCase extends BlueTriangleGoalCase {
	...
	public async visualize(scene: Scene, structure: BlueTriangleGoal): Promise<void> {
